...
# --- Step Synchronization using Session State ---
if 'active_tab' not in st.session_state:
    st.session_state['active_tab'] = '1️⃣ Data Input'

# Step Selector
step = st.selectbox(
    "Select Step:",
    ["1️⃣ Data Input", "2️⃣ Data Type Selection", "3️⃣ Assumption Check", "4️⃣ Group Selection", "5️⃣ Run Test"],
    index=["1️⃣ Data Input", "2️⃣ Data Type Selection", "3️⃣ Assumption Check", "4️⃣ Group Selection", "5️⃣ Run Test"].index(st.session_state['active_tab'])
)

# Update Session State based on Step Selection
st.session_state['active_tab'] = step

# Progress Bar
progress = ["1️⃣ Data Input", "2️⃣ Data Type Selection", "3️⃣ Assumption Check", "4️⃣ Group Selection", "5️⃣ Run Test"].index(st.session_state['active_tab']) + 1
...
# --- Tab 1: Data Input ---
if st.session_state['active_tab'] == "1️⃣ Data Input":
    with tab1:
...
if st.session_state['active_tab'] == "2️⃣ Data Type Selection":
    with tab2:
...
if st.session_state['active_tab'] == "3️⃣ Assumption Check":
    with tab3:
...
if st.session_state['active_tab'] == "4️⃣ Group Selection":
    with tab4:
        if 'data' in locals():
...
# --- Tab 5: Run Test ---
if st.session_state['active_tab'] == "5️⃣ Run Test":
    with tab5:
        if 'data' in locals():
